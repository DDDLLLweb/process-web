...
import { loadRoles, loadSingleRole, optRole, delRoles,updateRoleMenu } from './roles'
...
import { DO_ROLE_QUERY, DO_ROLE_INSERT, DO_ROLE_SINGLE, DO_ROLE_DELETE,DO_ROLE_MENU} from '../action/roles'
...
function* watchCreateLesson() {
  ...
  yield takeEvery(DO_ROLE_MENU,updateRoleMenu)
